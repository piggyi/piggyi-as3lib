...
//			trace(container1.getGlobalRect().x, container1.getGlobalRect().y, 
//			     container1.getGlobalRect().width, container1.getGlobalRect().height);
            trace(container1.getGlobalRect());
		}
